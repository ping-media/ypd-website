...
export default function Step2() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <Label>CSR Head / HR Head / Director Name</Label>
        <Input
          {...register("csrHeadName", {
            required: "CSR/HR/Director name is required",
          })}
      ...
      <div>
        ...
        <Input
          ...
          placeholder="CSR Manager / HR Head / Partnership Lead"
          className="mt-2"
        />
      ...
      <div>
        ...
        <Input
          ...
          placeholder="csr@company.com or hr@company.com"
          className="mt-2"
        />
        {errors.emailAddress && (
          <p className="mt-1 text-sm text-red-500">
