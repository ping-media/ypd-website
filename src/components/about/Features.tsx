...
export default function Features() {
  return (
    <section className="font-lato flex justify-center bg-white p-4 sm:p-10 lg:p-20">
      <div className="flex w-full max-w-[1440px] flex-col gap-8 sm:gap-14">
        {/* Heading + Intro */}
        <div className="mx-auto flex max-w-5xl flex-col gap-4 text-center">
          ...
          <p className="text-brand-gray w-full text-center text-base sm:text-lg">
        ...
        {/* Single Image - Replacing Old FeatureSections */}
        <div className="relative mx-auto h-[240px] w-full max-w-5xl overflow-hidden rounded-2xl shadow-md sm:h-[300px] lg:h-[400px]">
          <Image
            src="/about/info.png" // pick the most relevant image
            alt="Vision & Mission"
            fill
