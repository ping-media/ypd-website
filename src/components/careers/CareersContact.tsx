                  ...
                  render={() => (
                    <FormItem>
                      <FormControl>
                        <div
                          {...getRootProps()}
                          className={`flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 p-6 text-center transition ${isDragActive ? "border-green-600 bg-green-50" : ""}`}
                        >
                          <input {...getInputProps()} />
                          {!file ? (
                            <>
